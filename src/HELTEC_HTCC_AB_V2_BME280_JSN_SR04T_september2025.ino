...
//uint32_t appTxDutyCycle = 18000; // Verzending elke 0,3 minuten 
...
void loop() {
  ...
  // 🔧 DEBUG-MODUS: ook meten zonder join (als geen TTN dekking)
  //    prepareTxFrame(appPort);   // sensordata uitlezen
  //    delay(5000);               // elke 5 sec een nieuwe meting voor test
      LoRaWAN.join();
      break;
